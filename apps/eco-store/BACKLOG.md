...
| 0.6 | **BUG-003** PWA manifest tenant name ✅                             | MUST       | 0.5d  | —          | Done 2026-06-06 — name patch decoupled from logo presence in `PwaManifestService.applyBranding()`. CU `86c9uq8kj` (doc'd `86c9dn9m0` was stale)        |
...
| 7.14 | **TECH-05** `util/objects` reduce follow-up               | COULD      | 0.25d | 7.10       | Remaining 3 `reduce` fns → `for…in`. PR #1114 (dupe #1111 closed). CU `86ca59u6d`                                                                                                                           |
| 7.15 | **A11Y-003** Password visibility toggle a11y              | SHOULD     | 0.25d | —          | Tooltip + `aria-pressed` + label i18n. Best PR #1102 (dupe #1101 closed). CU `86ca59u4d`                                                                                                                    |
