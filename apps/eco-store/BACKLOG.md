...
**Document version:** 0.24 · **Last updated:** 2026-06-24
...
| 7.31 | **A11Y-009** `textarea-with-counter` `aria-live` + pre-limit warning                                  | SHOULD     | 0.25d | —          | `aria-live="polite"` on the count hint + `text-warning` at ~90% of `maxLength` before the existing `text-error`. Harvest from PR #1185. CU `86cadtkvb`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
