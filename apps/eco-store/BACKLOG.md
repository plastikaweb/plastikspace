...
**Document version:** 0.26 · **Last updated:** 2026-06-24
...
**Estimated effort:** ~13.25 dev-days
...
| 7.23 | **TECH-07** Cache system timezone in formatters                                                       | COULD      | 0.25d | —          | `Intl.DateTimeFormat().resolvedOptions().timeZone` recomputed inline per call in 3 date formatters (`shared-util-formatters.service.ts`); cache once as `#timezone` field. Sibling to TECH-06/SEC-01. PR #1147. CU `86ca8m6aj`                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| 7.32 | **TECH-11** Optimize `deepClone` + `escapeHtml` in `shared/util/objects`                              | COULD      | 0.25d | —          | `deepClone` → manual `for`/`for…in` loops; `escapeHtml` module-scope `map`+regex + `RegExp.test()` fast-path. Behaviour-identical; distinct from TECH-03/05/06. Harvest from PR #1183. CU `86cadtm4h`                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
