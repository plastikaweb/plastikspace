...
**Document version:** 0.17 · **Last updated:** 2026-06-21
...
| 7.24 | **SEC-04** Harden `NotificationUiMatSnackbar` `[innerHTML]`   | COULD      | 0.25d | —          | Swap `[innerHTML]="data.message"` → `{{ }}`. Deferred "optional extra" of SEC-03, never shipped. **LOW** defense-in-depth (Angular auto-sanitizes plain `[innerHTML]`; `message` is pre-translated) — _not_ the "HIGH" Jules labelled. PR #1161. CU `86cac31md`                                                                                                             |
