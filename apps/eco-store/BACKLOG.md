...
| 7.21 | **A11Y-006** Password toggle keyboard-focusable                | SHOULD     | 0.25d | —          | `tabindex="-1"` removes show/hide toggle from tab order (A11Y-003 left it unreachable). Evaluate vs. intentional Material behavior. PR #1128. CU `86ca5gpxj`                                                                                                                                                                                                                                                                                                               |
