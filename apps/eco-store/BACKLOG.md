...
**Document version:** 0.18 · **Last updated:** 2026-06-21
...
| 7.27 | **TECH-09** `latinize()` ASCII fast-path                       | COULD      | 0.25d | —          | Early-return for pure-ASCII input; skips `.replace()` + map lookup. **Distinct** from TECH-04 (regex narrowing). PR #1163. CU `86cac31p6`                                                                                                                                                                                                                                                                                                                                  |
