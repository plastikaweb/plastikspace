...
**Document version:** 0.20 · **Last updated:** 2026-06-21
...
| 7.22 | **TECH-06** Optimize `areObjectEntriesEqual`                   | COULD      | 0.25d | —          | `Object.keys().every()` → `for…in` (`util-objects.ts:165`); TECH-03/05 follow-up. PR #1129. CU `86ca5gpy1`                                                                                                                                                                                                                                                                                                                                                                 |
