...
**Document version:** 0.13 · **Last updated:** 2026-06-07
...
**Estimated effort:** ~10.75 dev-days
...
| 7.20 | **SEC-03** XSS in `SharedConfirmFeatureComponent`         | **Urgent** | 0.25d | —          | `bypassSecurityTrustHtml` on unescaped `translate` params (`shared-confirm-feature.component.ts:34-35`). HIGH. PR #1130. CU `86ca5gpx8`                                                                                                                                                               |
