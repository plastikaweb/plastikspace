...
| 7.26 | **TECH-08** Optimize `BytesToSizePipe`                         | COULD      | 0.25d | —          | Cache `Math.log(1024)`, drop `parseInt(String(…))` round-trip, optionally precompute 1024 powers. Sibling to TECH-03→07. PR #1155. CU `86cac31nm`                                                                                                                                                                                                                                                                                                                          |
