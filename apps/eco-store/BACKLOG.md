...
| 7.11 | **SEC-01** XSS escape in `SharedUtilFormattersService` | **Urgent** | 0.25d | —          | From Jules triage. `escapeHtml` in `defaultFormatter` + `booleanWithIconFormatter`. Best PR #1116 (dupes #1104/05/10/15 closed). CU `86ca59u6g`                                                         |
