...
**Document version:** 0.25 · **Last updated:** 2026-06-24
...
| 7.30 | **A11Y-008** `SharedAlert` close-button `matTooltip`                                                  | SHOULD     | 0.25d | —          | Add `matTooltip` mirroring `common.close` `aria-label` (sibling to A11Y-004/05/07). Harvest from PR #1182. CU `86cadtkh7`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
