...
| 7.12 | **SEC-02** Reverse-tabnabbing `rel=noopener`              | SHOULD     | 0.25d | —          | Workspace-wide `target="_blank"` links (eco-store + shared + llecoop + nasa). PR #1100. CU `86ca59u43`                                                                                                  |
| 7.13 | **TECH-04** Optimize `libs/shared/util/latinize`          | SHOULD     | 0.25d | —          | ASCII regex + Cyrillic `А` casing fix + spec. Best PR #1117 (dupes #1099/03/07/08/11 closed). CU `86ca59u10`                                                                                            |
