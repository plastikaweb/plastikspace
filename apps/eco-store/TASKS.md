...
**Document version:** 0.32 · **Last updated:** 2026-06-29
...
| **SEC-06** ✅ | XSS: Escape dynamic content in **llecoop** facade services and table configs (`Category`, `Product`, `User`, `OrderList`) before `confirm()` dialogs. The dialog message uses `bypassSecurityTrustHtml` for trusted markup, so dynamic variables like `item.name` or `item.email` must be escaped via `escapeHtml`. Applied `String(… ?? '')` to handle `LocalizedFields` and nulls. Added spec for `CategoryListFacadeService`. HIGH. **Done 2026-06-29** — harvest from Jules #1203.                                                                                                                                                                                                                                                                                                                                                                                                                                                | **Urgent** | `86cajqprd` |
...
| Version | Date       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.32    | 2026-06-29 | **SEC-06 done** (task 7.36) — escaped dynamic user-controlled data (`item.name`, `item.email`, etc.) in Llecoop facade services and table configs before passing to `confirm()` dialogs. Combined `escapeHtml` with `String(… ?? '')` to harden against reflected XSS while supporting `LocalizedFields`. Added a verification spec in `llecoop-category-feature-list`. Harvest from Jules #1203 (dupes #1204/#1209 closed). CU `86cajqprd`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
