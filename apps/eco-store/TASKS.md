...
- **A11Y-006** ✅ — Password visibility toggle not keyboard-focusable (`tabindex="-1"`); A11Y-003 left it unreachable via Tab [SHOULD · ✅ 2026-06-07 · ClickUp `86ca5gpxj`]
...
| Version | Date       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.15    | 2026-06-07 | **A11Y-006 done** — Removing `tabindex="-1"` from the password visibility toggle in `input-password-with-visibility` ensures keyboard focusability and compliance with WCAG 2.1 AA standards. CU `86ca5gpxj`.                                                                                                                                                                                                                                            |
