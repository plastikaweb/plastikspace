...
**Document version:** 0.32 · **Last updated:** 2026-07-14
...
| **SEC-07** ✅ | XSS: Harden `SharedConfirmFeatureComponent` parameter escaping — convert all translation parameters to strings via `String(value ?? '')` before `escapeHtml` to prevent non-string bypasses (e.g. arrays) stringified by `ngx-translate` — MEDIUM | **Urgent** | `86cajqprk` |
...
| Version | Date       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.32    | 2026-07-14 | **SEC-07 done** — hardened `SharedConfirmFeatureComponent` parameter escaping: now forces stringification (`String(value ?? '')`) before `escapeHtml` for all translation parameters. Prevents XSS when non-string values (like arrays) containing HTML are passed and later stringified by `ngx-translate`. Added reproduction spec. CU `86cajqprk`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
