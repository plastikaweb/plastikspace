...
| **TECH-13** _(new)_ | Optimize formatting services: implement `Map`-based cache for split property paths in `DataFormatFactoryService` and replace object spreads with direct property access in `SharedUtilFormattersService` to reduce allocation overhead and GC pressure.                                                                                                                                                                                                                                                                                                                                                                                                                         | SHOULD   | `86cajqpt6` |
...
| Version | Date       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.30    | 2025-05-15 | **TECH-13 done** — optimized formatting services (`DataFormatFactoryService` + `SharedUtilFormattersService`) by implementing path caching, fast-paths for simple property access, and removing redundant object allocations. Verified with benchmarks (~2.8x - 4.1x faster) and unit tests. PR (this branch). CU `86cajqpt6`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
