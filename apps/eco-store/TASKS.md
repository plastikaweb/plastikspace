...
| **SEC-08** ✅ | Harden residual SEC-05 sinks — escape the output of \`LlecoopProductBaseUnitTextPipe\` inside \`LlecoopUserOrderDetailFormTableConfig\` and \`LlecoopUserOrderResumeTableConfig\` before \`bypassSecurityTrustHtml\`. Severity: LOW defense-in-depth (unit.base is typed number, admin-controlled). **Done 2026-07-04** — applied \`escapeHtml\` to the pipe output in both \`CUSTOM\` formatters. Added security comments. | SHOULD     | \`86cajqprw\` |
...
| Version | Date       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.32    | 2026-07-04 | **SEC-08 done** (task 7.38) — hardened residual SEC-05 sinks: escaped the output of \`LlecoopProductBaseUnitTextPipe\` in \`LlecoopUserOrderDetailFormTableConfig\` and \`LlecoopUserOrderResumeTableConfig\` before \`bypassSecurityTrustHtml\`. Added security comments. Severity: LOW (unit.base is typed number, admin-controlled). CU \`86cajqprw\`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
