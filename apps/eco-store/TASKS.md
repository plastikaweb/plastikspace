...
**Document version:** 0.32 · **Last updated:** 2026-07-02
...
- **A11Y-012** ✅ — Shared table accessibility & i18n (`libs/shared/table/ui`): added context-aware `aria-label` + `matTooltip` to row expansion buttons (e.g., "Expand row [Name]"), replaced hardcoded "Accions" header with `common.actions` key, and cleaned up expansion column header (removed redundant labels + added `common.a11y.expandColumn` screen-reader hint). Handles `LocalizedFields` for entity names via `getDisplayName()` helper. [SHOULD · ✅ 2026-07-02 · ClickUp `86cajqptj`]
...
| Version | Date       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.32    | 2026-07-02 | **A11Y-012 done** (task 7.41) — Improved `SharedTableUiComponent` accessibility and i18n. Added context-aware labels to expand buttons, localized "Actions" header, and handled `LocalizedFields` for entity names. CU `86cajqptj`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
