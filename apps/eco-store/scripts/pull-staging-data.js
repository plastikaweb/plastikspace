          ...
          for (const field of fileFields) {
            ...
            if (files) {
              ...
              for (const filename of fileList) {
                ...
                try {
                  // Use staging file token if available or just public URL if rules allow
...
async function run() {
  try {
    console.log('🚀 Starting data pull from staging to local...');
    ...
    console.error('\n💥 Critical error during pull:', err.message);
    process.exit(1);
  }
}
