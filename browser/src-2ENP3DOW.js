...
var SharedImgContainerComponent = class _SharedImgContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SharedImgContainerComponent, selectors: [["plastik-img-container"]], hostAttrs: [1, "relative", "block"], inputs: { src: [1, "src"], title: [1, "title"], dimensions: [1, "dimensions"], quality: [1, "quality"], lcpImage: [1, "lcpImage"], sizes: [1, "sizes"], thumbSizes: [1, "thumbSizes"] }, decls: 7, vars: 6, consts: [["fixedImage", ""], ["fillImage", ""], [1, "absolute", "inset-0", "flex", "items-center", "justify-center", "bg-transparent"], [1, "border-tertiary-600", "h-8", "w-8", "animate-spin", "rounded-full", "border-b-2"], [1, "image-error", "flex", "h-full", "w-full", "items-center", "justify-center", "bg-neutral-50"], [1, "scale-200"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "h-full", "w-full", "object-cover", "transition-opacity", "duration-200", 3, "load", "error", "priority", "ngSrc", "width", "height", "alt", "loaderParams"], ["fill", "", 1, "h-full", "w-full", "object-cover", "transition-opacity", "duration-200", 3, "load", "error", "priority", "ngSrc", "alt", "sizes", "ngSrcset", "loaderParams"]], template: function SharedImgContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275declareLet(0)(1)(2);
...
//# sourceMappingURL=src-2ENP3DOW.js.map
