import {
  ...
  SvgIconComponent
} from "./chunk-5CHSBOVZ.js";
import {
  MAT_SNACK_BAR_DEFAULT_OPTIONS
} from "./chunk-C5W2M2FP.js";
import {
  MatToolbar,
  MatToolbarModule
...
var _c06 = ["*"];
var SharedActivityUiOverlayComponent = class _SharedActivityUiOverlayComponent {
...
var CoreCmsLayoutFeatureComponent_Defer_8_DepsFn = () => [import("./src-MGI2XM3R.js").then((m) => m.NotificationUiMatSnackbarDirective)];
var CoreCmsLayoutFeatureComponent_Defer_14_DepsFn = () => [NgTemplateOutlet];
var CoreCmsLayoutFeatureComponent_Defer_34_DepsFn = () => [import("./src-Y25KIHIA.js").then((m) => m.CoreCmsLayoutUiFooterComponent), DatePipe];
var _c16 = () => ["/"];
...
function CoreCmsLayoutFeatureComponent_For_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-list-item", 19)(1, "mat-icon", 20);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function CoreCmsLayoutFeatureComponent_Defer_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "plastik-core-cms-layout-ui-footer", 22)(1, "div", 23);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementStart(4, "a", 24);
    \u0275\u0275text(5, "Plastikaweb");
    \u0275\u0275elementEnd();
    \u0275\u0275text(6, " | ");
    \u0275\u0275elementStart(7, "a", 25);
    \u0275\u0275text(8, "El Llevat");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var CoreCmsLayoutFeatureComponent = class _CoreCmsLayoutFeatureComponent {
  ...
  widgetsContainer = viewChild("widgetsContainer", ...ngDevMode ? [{ debugName: "widgetsContainer", read: ViewContainerRef }] : [{
  ...
  static \u0275fac = function CoreCmsLayoutFeatureComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CoreCmsLayoutFeatureComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CoreCmsLayoutFeatureComponent, selectors: [["plastik-core-cms-layout-feature"]], viewQuery: function CoreCmsLayoutFeatureComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx.widgetsContainer, _c07, 5, ViewContainerRef);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(CoreCmsLayoutFeatureComponent, () => [import("./src-MGI2XM3R.js").then((m) => m.NotificationUiMatSnackbarDirective), import("./src-Y25KIHIA.js").then((m) => m.CoreCmsLayoutUiFooterComponent)], (NotificationUiMatSnackbarDirective, CoreCmsLayoutUiFooterComponent) => {
...
` }]
    }], null, { hideFooter: [{ type: Input, args: [{ isSignal: true, alias: "hideFooter", required: false }] }], widgetsContainer: [{ type: ViewChild, args: ["widgetsContainer", __spreadProps(__spreadValues({}, {
      read: ViewContainerRef
    }), { isSignal: true })] }] });
  });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CoreCmsLayoutFeatureComponent, { className: "CoreCmsLayoutFeatureComponent", filePath: "libs/core/cms-layout/feature/src/lib/core-cms-layout-feature/core-cms-layout-feature.component.ts", lineNumber: 57 });
})();
...
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["plastik-root"]], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "plastik-core-cms-layout-feature");
    }
  }, dependencies: [CoreCmsLayoutFeatureComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "plastik-root", imports: [CoreCmsLayoutFeatureComponent], template: "<plastik-core-cms-layout-feature></plastik-core-cms-layout-feature>\n" }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "apps/nasa-images/src/app/app.component.ts", lineNumber: 9 });
})();
...
var routes = [
  {
    path: "search",
    loadChildren: () => import("./src-7MTV52XG.js").then((routes2) => routes2.nasaImagesSearchFeatureRoutes)
  },
  {
    path: "faqs",
    loadChildren: () => import("./src-5O6LLGAI.js").then((routes2) => routes2.nasaImagesFaqsFeatureRoutes)
  },
...
var headerConfig = {
  ...
  widgetsConfig: {
    ...
    widgets: [
      {
        id: 1,
        component: () => import("./src-C4ATEQ5G.js").then((c) => c.SharedButtonUiComponent),
        inputs: {
          config: {
            type: "link",
...
var appConfig = {
  providers: [
    ...
    provideStore(),
    importProvidersFrom(A11yModule, AngularSvgIconModule.forRoot(), StoreModule.forRoot(routerReducers, {
      runtimeChecks: {
        strictActionImmutability: true,
        strictStateImmutability: true
      }
    }), EffectsModule.forRoot([RouterStateEffects]), isDevMode() ? StoreDevtoolsModule.instrument({
      name: environment.name,
      maxAge: 25,
      connectInZone: true
    }) : [], CoreCmsLayoutDataAccessModule, notificationStore, activityStore),
    ...NASA_IMAGES_PROVIDERS,
    provideRouterStore({
