...
var routes = [
  {
    path: "search",
    loadChildren: () => import("./src-NAIM6GEQ.js").then((routes2) => routes2.nasaImagesSearchFeatureRoutes)
  },
  {
    path: "faqs",
    loadChildren: () => import("./src-7KC5PLWK.js").then((routes2) => routes2.nasaImagesFaqsFeatureRoutes)
  },
