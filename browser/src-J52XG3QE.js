...
import "./chunk-GMRUW7HA.js";
import {
  _isNumberValue
} from "./chunk-XOAPZXSA.js";
import {
...
var SharedTableUiComponent_Defer_3_DepsFn = () => [import("./router-PWWIO6JW.js").then((m) => m.RouterLink), import("./common-BMYC5HWG.js").then((m) => m.NgComponentOutlet), import("./common-BMYC5HWG.js").then((m) => m.NgTemplateOutlet), import("./text-field-H6TZ7JYP.js").then((m) => m.CdkTextareaAutosize), MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatSort, MatSortHeader, MatTooltip, MatIcon, MatIconButton, MatFormField, MatPrefix, MatSuffix, MatInput, MatSelect, MatOption, MatCheckbox, MatRadioGroup, MatRadioButton, MatSlideToggle, import("./common-BMYC5HWG.js").then((m) => m.NgOptimizedImage), import("./common-BMYC5HWG.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-HOTDGWL3.js").then((m) => m.OrderTableActionsElementsPipe), SafeFormattedPipe];
var _c3 = (a0) => [a0];
...
function SharedTableUiComponent_Defer_1_Conditional_5_mat_cell_4_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.expandedDetailTpl())("ngTemplateOutletContext", \u0275\u0275pureFunction2(2, _c4, element_r27, element_r27.id === ((tmp_7_0 = ctx_r1.expandedElement()) == null ? null : tmp_7_0.id)));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(SharedTableUiComponent, () => [import("./router-PWWIO6JW.js").then((m) => m.RouterLink), import("./common-BMYC5HWG.js").then((m) => m.NgComponentOutlet), import("./common-BMYC5HWG.js").then((m) => m.NgTemplateOutlet), import("./text-field-H6TZ7JYP.js").then((m) => m.CdkTextareaAutosize), import("./common-BMYC5HWG.js").then((m) => m.NgOptimizedImage), import("./common-BMYC5HWG.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-HOTDGWL3.js").then((m) => m.OrderTableActionsElementsPipe)], (RouterLink, NgComponentOutlet, NgTemplateOutlet, CdkTextareaAutosize, NgOptimizedImage, KeyValuePipe, OrderTableActionsElementsPipe) => {
