...
var SharedTableUiComponent_Defer_3_DepsFn = () => [import("./router-7DBLISW5.js").then((m) => m.RouterLink), import("./common-Z7HYMP6V.js").then((m) => m.NgComponentOutlet), import("./common-Z7HYMP6V.js").then((m) => m.NgTemplateOutlet), import("./text-field-EKFIANVV.js").then((m) => m.CdkTextareaAutosize), MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatSort, MatSortHeader, MatTooltip, MatIcon, MatIconButton, MatFormField, MatPrefix, MatSuffix, MatInput, MatSelect, MatOption, MatCheckbox, MatRadioGroup, MatRadioButton, MatSlideToggle, import("./common-Z7HYMP6V.js").then((m) => m.NgOptimizedImage), import("./common-Z7HYMP6V.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-K36JIL6E.js").then((m) => m.OrderTableActionsElementsPipe), SafeFormattedPipe];
var _c3 = (a0) => [a0];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(SharedTableUiComponent, () => [import("./router-7DBLISW5.js").then((m) => m.RouterLink), import("./common-Z7HYMP6V.js").then((m) => m.NgComponentOutlet), import("./common-Z7HYMP6V.js").then((m) => m.NgTemplateOutlet), import("./text-field-EKFIANVV.js").then((m) => m.CdkTextareaAutosize), import("./common-Z7HYMP6V.js").then((m) => m.NgOptimizedImage), import("./common-Z7HYMP6V.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-K36JIL6E.js").then((m) => m.OrderTableActionsElementsPipe)], (RouterLink, NgComponentOutlet, NgTemplateOutlet, CdkTextareaAutosize, NgOptimizedImage, KeyValuePipe, OrderTableActionsElementsPipe) => {
...
//# sourceMappingURL=src-TM6NAWKL.js.map
