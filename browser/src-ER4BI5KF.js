...
var SharedTableUiComponent_Defer_3_DepsFn = () => [import("./router-4F6JC5EE.js").then((m) => m.RouterLink), import("./common-36ZM63XL.js").then((m) => m.NgComponentOutlet), import("./common-36ZM63XL.js").then((m) => m.NgTemplateOutlet), import("./text-field-VYOK36TG.js").then((m) => m.CdkTextareaAutosize), MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatSort, MatSortHeader, MatTooltip, MatIcon, MatIconButton, MatFormField, MatPrefix, MatSuffix, MatInput, MatSelect, MatOption, MatCheckbox, MatRadioGroup, MatRadioButton, MatSlideToggle, import("./common-36ZM63XL.js").then((m) => m.NgOptimizedImage), import("./common-36ZM63XL.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-OTITFNIK.js").then((m) => m.OrderTableActionsElementsPipe), SafeFormattedPipe];
var _c3 = (a0) => [a0];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(SharedTableUiComponent, () => [import("./router-4F6JC5EE.js").then((m) => m.RouterLink), import("./common-36ZM63XL.js").then((m) => m.NgComponentOutlet), import("./common-36ZM63XL.js").then((m) => m.NgTemplateOutlet), import("./text-field-VYOK36TG.js").then((m) => m.CdkTextareaAutosize), import("./common-36ZM63XL.js").then((m) => m.NgOptimizedImage), import("./common-36ZM63XL.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-OTITFNIK.js").then((m) => m.OrderTableActionsElementsPipe)], (RouterLink, NgComponentOutlet, NgTemplateOutlet, CdkTextareaAutosize, NgOptimizedImage, KeyValuePipe, OrderTableActionsElementsPipe) => {
...
//# sourceMappingURL=src-ER4BI5KF.js.map
