...
var NasaImagesFaqsFeatureComponent = class _NasaImagesFaqsFeatureComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NasaImagesFaqsFeatureComponent, selectors: [["plastik-nasa-images-faqs-feature"]], decls: 7, vars: 5, consts: [["data-test", "page-title", 1, "flex", "items-center", "gap-sm", "h3"], [1, "faqs-wrapper"], [1, "mx-xl", "my-md"], ["data-test", "faq-item"], ["data-test", "faq-question", 1, "h5"], ["data-test", "faq-answer", 3, "innerHTML"]], template: function NasaImagesFaqsFeatureComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, NasaImagesFaqsFeatureComponent_Conditional_0_Template, 5, 2, "h2", 0);
      \u0275\u0275pipe(1, "ngrxPush");
      \u0275\u0275elementStart(2, "section", 1)(3, "mat-accordion", 2);
      \u0275\u0275repeaterCreate(4, NasaImagesFaqsFeatureComponent_For_5_Template, 7, 2, "mat-expansion-panel", 3, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275pipe(6, "ngrxPush");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NasaImagesFaqsFeatureComponent, { className: "NasaImagesFaqsFeatureComponent", filePath: "libs/nasa-images/faqs/feature/src/lib/nasa-images-faqs-feature/nasa-images-faqs-feature.component.ts", lineNumber: 15 });
})();
...
//# sourceMappingURL=src-5O6LLGAI.js.map
