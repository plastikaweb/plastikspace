...
var SharedTableUiComponent_Defer_3_DepsFn = () => [import("./router-IYAWXPUG.js").then((m) => m.RouterLink), import("./common-6QDGNUHV.js").then((m) => m.NgComponentOutlet), import("./common-6QDGNUHV.js").then((m) => m.NgTemplateOutlet), import("./text-field-K3BWMX2S.js").then((m) => m.CdkTextareaAutosize), MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatSort, MatSortHeader, MatTooltip, MatIcon, MatIconButton, MatFormField, MatPrefix, MatSuffix, MatInput, MatSelect, MatOption, MatCheckbox, MatRadioGroup, MatRadioButton, MatSlideToggle, import("./common-6QDGNUHV.js").then((m) => m.NgOptimizedImage), import("./common-6QDGNUHV.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-YLKJLR4H.js").then((m) => m.OrderTableActionsElementsPipe), SafeFormattedPipe];
var _c3 = (a0) => [a0];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(SharedTableUiComponent, () => [import("./router-IYAWXPUG.js").then((m) => m.RouterLink), import("./common-6QDGNUHV.js").then((m) => m.NgComponentOutlet), import("./common-6QDGNUHV.js").then((m) => m.NgTemplateOutlet), import("./text-field-K3BWMX2S.js").then((m) => m.CdkTextareaAutosize), import("./common-6QDGNUHV.js").then((m) => m.NgOptimizedImage), import("./common-6QDGNUHV.js").then((m) => m.KeyValuePipe), import("./order-table-actions-elements.pipe-YLKJLR4H.js").then((m) => m.OrderTableActionsElementsPipe)], (RouterLink, NgComponentOutlet, NgTemplateOutlet, CdkTextareaAutosize, NgOptimizedImage, KeyValuePipe, OrderTableActionsElementsPipe) => {
...
//# sourceMappingURL=src-QRPAZHDH.js.map
