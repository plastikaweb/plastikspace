...
describe('SharedButtonUiComponent', () => {
  ...
  describe('disabled state', () => {
    ...
    it('should not add aria-disabled or tabindex when enabled for link', () => {
      fixture.componentRef.setInput('buttonConfig', { ...buttonAsLinkMock, disabled: false, link: '/test' });
      fixture.detectChanges();
      const link = fixture.nativeElement.querySelector('a');
  ...
  describe('accessibility', () => {
    it('should only hide internal icon elements from screen readers', () => {
