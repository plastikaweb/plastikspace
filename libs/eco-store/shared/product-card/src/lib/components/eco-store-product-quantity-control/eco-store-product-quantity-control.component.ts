...
@Component({
  ...
  templateUrl: './eco-store-product-quantity-control.component.html',
  styleUrl: './eco-store-product-quantity-control.component.scss',
  host: {
    class: 'block w-full',
  },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EcoStoreProductQuantityControlComponent {
