...
import { TABLE_WITH_FILTERING_FACADE } from '@plastik/core/list-view';
...
import { OrderListUserOrderFeatureListComponent } from './order-list-user-order-feature-list.component';
...
export const llecoopOrderListUserOrdersListRoutes: Route[] = [
  {
    ...
    component: OrderListUserOrderFeatureListComponent,
    providers: [
      {
