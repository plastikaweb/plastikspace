...
export class CoreNotificationUiMatSnackbarDirective implements OnChanges, OnDestroy {
  ...
  open(config: Notification) {
    ...
    const snackBarRef = this.snackBar.openFromComponent(CoreNotificationUiMatSnackbarComponent, snackBarConfig);
