...
import { NasaImagesEffects, NasaImagesSearchFacade, selectNasaImagesFeature } from '@plastik/nasa-images/search/data-access';
...
export const nasaImagesSearchFeatureRoutes: Routes = [
  {
    ...
    providers: [provideState(selectNasaImagesFeature), provideEffects(NasaImagesEffects), NasaImagesSearchFacade],
